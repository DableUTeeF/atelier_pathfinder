IconSelect.DEFAULT = {};
IconSelect.DEFAULT.SELECTED_ICON_WIDTH = 52;
IconSelect.DEFAULT.SELECTED_ICON_HEIGHT = 52;
IconSelect.DEFAULT.SELECTED_BOX_PADDING = 1;
IconSelect.DEFAULT.SELECTED_BOX_PADDING_RIGHT = 12;
IconSelect.DEFAULT.ICONS_WIDTH = 52;
IconSelect.DEFAULT.ICONS_HEIGHT = 52;
IconSelect.DEFAULT.BOX_ICON_SPACE = 1;
IconSelect.DEFAULT.HORIZONTAL_ICON_NUMBER = 3;
IconSelect.DEFAULT.VECTORAL_ICON_NUMBER = 3;

IconSelect.COMPONENT_ICON_FILE_PATH = "static/imgs/control/arrow.png";
...
function IconSelect($$elementID, $$parameters) {
    ...
    _View.createUI = function($parameters){
        ...
        */
        ...
        _View.selectedIconTextElement = document.createElement('div');
        _View.selectedIconTextElement.innerHTML = "";
        selectedIconElement.appendChild(_View.selectedIconTextElement);
    ...
    _View.createIcon = function($iconFilePath, $iconValue, $index, $parameters){
        ...
        iconTextElement.innerHTML = $iconValue;
